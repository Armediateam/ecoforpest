...
class FinanceJournalExport implements FromView, ShouldAutoSize
{
    ...
    public function view(): View
    {
        ...
        $totalIncome = 0;
        $totalExpense = 0;
        $financeTransaction = FinanceTransaction::whereIn('id', $this->transactions)->get();
        foreach ($financeTransaction as $trx) {
