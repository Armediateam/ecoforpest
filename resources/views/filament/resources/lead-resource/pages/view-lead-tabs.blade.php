                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-slate-900 dark:text-slate-100 flex items-center">
                                {{ $record->name }}
                                @php
                                    $statusName = $record->status->name ?? 'Pending';
                                    $bgColor = match ($statusName) {
                                        'Pending'
                                ...
                                @endphp
                                <span
                                    class="ml-3 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $bgColor }}">
                                    {{ $statusName }}
                                </span>
                            </h1>
